    ...
    <>
      ...
      <div className='inner'>
        <h2 className='firstQ'>What is it?</h2>
          <p>During a plasma-only donation, blood is drawn from one arm and sent through a high-tech machine that collects your plasma and then safely and comfortably returns your red cells and platelets back to you, along with some saline. It takes only a few minutes longer than donating blood but can have a profound impact.</p>
