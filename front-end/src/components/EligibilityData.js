...
export const EligibilityData = [
...

    {
        ...
        links: [<Link to="./informationforteens" className='linkStyle'>See aditional requirements for students!</Link>, <Link to="./plateletdonation" className='linkStyle'> Learn more about platelet donation</Link> ]
    },
...

    {
        ...
        links: [<Link to="./informationforteens" className='linkStyle'>See aditional requirements for students!</Link>, <Link to="./abeliteplasmadonation" className='linkStyle'> Learn more about plasma donation</Link> ]
    },
