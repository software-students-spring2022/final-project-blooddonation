                            ...
                            :answerObj.subHeading === "Your donation" ?
                                ...
                                <>
                                  <Ul>
                                    ...
                                    <li key="don2">Other types of donations, like <NavLink to="./eligibility/plateletdonation" className='linkStyle'>platelets</NavLink>, are made using 
                                        an aphaeresis machine that will be connected to both arms.</li>
                                    <li key="don3">A <NavLink to="./eligibility/wholeblooddonation" className='linkStyle'>whole blood donation</NavLink> takes 8-10 minutes, during which 
