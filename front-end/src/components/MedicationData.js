export const MedicationData = [

    {
      question: 'Aspirin',
      answer: [ { subHeading: "",
                  points: ["Aspirin, no waiting period for donating whole blood. However, you must wait 2 full days after taking aspirin or any medication containing aspirin before donating platelets by apheresis. For example, if you take aspirin products on Monday, the soonest you may donate platelets is Thursday."]
                }
      ]
    },

    {
      ...
      answer: [ { subHeading: "",
                  points: [ "A donor with an acute infection should not donate. The reason for antibiotic use must be evaluated to determine if the donor has a bacterial infection that could be transmissible by blood.",
...

    {
      ...
      answer: [ { subHeading: "",
                  points: ["Women on oral contraceptives or using other forms of birth control are eligible to donate."]
                }
      ]
    },

    {
      ...
      answer: [ { subHeading: "",
                  points: [ "Acceptable if you were vaccinated for influenza, pneumonia, tetanus or meningitis, providing you are symptom-free and fever-free. Includes the Tdap vaccine. ",
...

    {
        question: 'Insulin',
        answer: [ { subHeading: "",
                    points: ["Donors with diabetes who take any kind of insulin are eligible to donate as long their diabetes is well controlled. "]
                  }
        ]
    },
...

    {
        ...
        answer: [ { subHeading: "",
                    points: [ "Accutane, Amnesteem, Absorica, Claravis, Myorisan, Sotret or Zenatane (isotretinoin), Proscar (finasteride), and Propecia (finasteride) - wait 1 month from the last dose. ",
                            "Avodart or Jalyn (dutasteride) - wait 6 months from the last dose.", "Aspirin, no waiting period for donating whole blood. However, you must wait 2 full days after taking aspirin or any medication containing aspirin before donating platelets by apheresis. For example, if you take aspirin products on Monday, the soonest you may donate platelets is Thursday.",
                            ...
                            "Hepatitis B Immune Globulin - given for exposure to hepatitis, wait 12 months after exposure to hepatitis.", "HIV Prevention (PrEP and PEP) medications - Truvada (Tenofovir), Descovy (emtricitabine), Tivicay (dolutegravir) and  Isentress (raltegravir) are given for exposure to HIV, you must wait 3 months after the last dose of medication to donate.",
                            "HIV treatment also known as antiretroviral therapy (ART) at any time - you are not eligible to donate blood.", "Plavix (clopidogrel) and Ticlid (ticlopidine) - no waiting period for donating whole blood. However, you must wait 14 days after taking this medication before donating platelets by apheresis.",
                            "Zontivity (vorapaxar) - no waiting period for donating whole blood. However, you must wait 1 month after taking this medication before donating platelets by apheresis.", "Rinvoq (upadacitinib) - wait 1 month", "Thalomid (thalidomide) - wait 1 month.", "Cellcept (mycophenolate mofetil) - an immunosuppressant - wait 6 weeks",
                            "Soriatane (acitretin) - wait 3 years.", "Tegison (etretinate) at any time - you are not eligible to donate blood.", "Arava (leflunomide),  Erivedge (vismodegib) and Odomzo (sonidegib)- wait 2 years.", "Aubagio (teriflunomide) - wait 2 years."
